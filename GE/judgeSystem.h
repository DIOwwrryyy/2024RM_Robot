...
}__attribute__ ((__packed__)) tdata;
...
typedef  struct
{
  ...
  uint32_t end_x : 11;
  uint32_t end_y : 11;
}__attribute__ ((__packed__)) ext_graphic_data_struct_t;
...
}__attribute__ ((__packed__)) ext_uixianduan;

typedef  struct
{
  ext_graphic_data_struct_t		fu[7];
}__attribute__ ((__packed__)) ext_dianrong;
...
typedef  struct
{
  ext_graphic_data_struct_t		graphic_data_struct_t;
  char   shuju[30];
}__attribute__ ((__packed__)) ext_client_custom_shuzi_t;
...
typedef struct
{
  ...
  uint16_t              CRC16;
}__attribute__ ((__packed__)) hypTypedef;
...
typedef  struct
{
  ...
  uint16_t              					CRC16;
}__attribute__ ((__packed__)) ziTypedef;
...
typedef  struct
{
  ...
  ext_dianrong 										dong;
  uint16_t                        CRC16;
}__attribute__ ((__packed__)) dianrongTypedef;
...
typedef  struct
{
  ...
  ext_client_custom_character_t 	zifu;
  uint16_t                        CRC16;
}__attribute__ ((__packed__)) tuoluoTypedef;
...
typedef  struct
{
  ...
  uint16_t                        CRC16;
}__attribute__ ((__packed__)) tupTypedef;
