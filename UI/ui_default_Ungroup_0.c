...
ui_interface_string_t* ui_default_Ungroup_CAP_root = &ui_default_Ungroup_0.option;
...
void _ui_init_default_Ungroup_0() {
    ...
    ui_default_Ungroup_0.option.font_size = 40;
    ui_default_Ungroup_0.option.start_x = 1455;
    ui_default_Ungroup_0.option.start_y = 358;
    ui_default_Ungroup_0.option.color = 1;
    ui_default_Ungroup_0.option.str_length = 14;
    ui_default_Ungroup_0.option.width = 4;
    strcpy(ui_default_Ungroup_CAP_root->string, "电容尚未启动！ctrl+C！");
